    ...
    <section class="bg-white dark:bg-gray-900 w-full">
        <div class="container px-6 py-12 mx-auto">
            <div class="text-center">
                <p class="font-medium text-teal-500 dark:text-teal-600">Contact us</p>
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                <div class="flex flex-col items-center justify-center text-center">
                    <span class="p-3 text-teal-600 rounded-full bg-teal-100/80 dark:bg-gray-800">
                    ...
                    <p class="mt-2 text-teal-600 dark:text-teal-600">hello@merakiui.com</p>
                </div>
                ...
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <p class="mt-2 text-teal-600 dark:text-teal-600">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <p class="mt-2 text-teal-600 dark:text-teal-600">+1 (555) 000-0000</p>
                </div>
            </div>
        </div>
    </section>
