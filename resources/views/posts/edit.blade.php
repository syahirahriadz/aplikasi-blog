        ...
        <div class="max-w-6xl mx-auto px-6 py-30">
            ...
            <form action="{{ route('posts.update', $post->slug) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="author" id="author" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="{{ old('author', $post->author) }}">
                    @error('author')
                        <span class="text-red-500 text-sm">{{ $message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="author_info" id="author_info" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="{{ old('author_info', $post->author_info) }}">
                    @error('author_info')
                        <span class="text-red-500 text-sm">{{ $message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="image" id="image" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2" value="{{ old('image', $post->image) }}">
                    @error('image')
                        <span class="text-red-500 text-sm">{{ $message}}</span>
                    @enderror
                </div>
